<div class="row">
    <div class="col-md-12">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <input type="text" name="last_name" id="last_name" value="{{old('last_name',$contact->lastname)}}" class="form-control @error('last_name') is-invalid @enderror">
          @error('last_name')
          <div class="invalid-feedback">
            {{$message}}
        </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <select name="company_id" id="company_id" value="{{old('company')}}" class="form-control @error('company_id') is-invalid @enderror">
