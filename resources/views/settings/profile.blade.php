                  ...
                  <div class="row">
                    <div class="col-md-8">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="last_name"  value="{{old('last_name', $user->lastt_name)}}" id="last_name" class="form-control @error('last_name')is-invalid @enderror">
                          @error('last_name')
                          <div class="invalid-feedback">
                           {{$message}}
                          </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="company" id value="{{old('company', $user->company)}}" id="company" class="form-control @error('company')is-invalid @enderror">
                          @error('company')
                          <div class="invalid-feedback">
                           {{$message}}
                          </div>
                      ...
                      <div class="form-group">
                          ...
                          <textarea name="bio" rows="3" id="bio" class="form-control">{{old('bio', $user->bio)}}</textarea>
                      </div>
                    </div>
